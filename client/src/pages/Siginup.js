        ...
        <div className='card-from'>
            ...
            <form className='form' onSubmit={handleSubmit}>
                ...
                <div className='form-element'>
                    ...
                    <div className='input-container'>
                        <input type='text' id='location' name='location' value={data.location} disabled={loading} onChange={handleOnChange}/>
                    </div>
                </div>
                ...
                <div className='form-element'>
                    ...
                    <div className='input-container'>
                        <input type='text' id='interests' name='interests' value={data.interests} disabled={loading} onChange={handleOnChange}/>
                    </div>
                </div>
